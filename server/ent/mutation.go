...
type EntryMutation struct {
	...
	heading       *string
	body          *string
	attributes    *schema.EntryAttributes
...
func (m *EntryMutation) SetAttributes(sa schema.EntryAttributes) {
	m.attributes = &sa
}

// Attributes returns the value of the "attributes" field in the mutation.
func (m *EntryMutation) Attributes() (r schema.EntryAttributes, exists bool) {
	v := m.attributes
	if v == nil {
		return
	}
...
// If the Entry object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *EntryMutation) OldAttributes(ctx context.Context) (v schema.EntryAttributes, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *EntryMutation) SetField(name string, value ent.Value) error {
	...
	case entry.FieldBody:
		...
		return nil
	case entry.FieldAttributes:
		v, ok := value.(schema.EntryAttributes)
		if !ok {
			return fmt.Errorf("unexpected type %T for field %s", value, name)
		}
		m.SetAttributes(v)
...
// SetSettings sets the "settings" field.
func (m *VaultMutation) SetSettings(ss schema.VaultSettings) {
	m.settings = &ss
}

// Settings returns the value of the "settings" field in the mutation.
func (m *VaultMutation) Settings() (r schema.VaultSettings, exists bool) {
	v := m.settings
	if v == nil {
		return
	}
...
// If the Vault object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *VaultMutation) OldSettings(ctx context.Context) (v schema.VaultSettings, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldSettings is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
func (m *VaultMutation) SetField(name string, value ent.Value) error {
	...
	case vault.FieldName:
		...
		return nil
	case vault.FieldSettings:
		v, ok := value.(schema.VaultSettings)
		if !ok {
			return fmt.Errorf("unexpected type %T for field %s", value, name)
		}
		m.SetSettings(v)
